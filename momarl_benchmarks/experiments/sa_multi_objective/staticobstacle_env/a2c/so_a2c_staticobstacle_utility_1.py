...
wandb_name = "A2C_StaticOnstacleEnv_Utility_1"

a2c_agent = A2C(env, LR, GAMMA, linear_utility_f,vectorial_reward=True)
a2c_agent.train(15_000, enable_wandb_logging="online", wandb_group_name="SO_A2C_StaticOnstacleEnv_Utility_1", wandb_name=wandb_name)