...
wandb_name = "MO_DQN_StaticOnstacleEnv_Utility_2"

dqn_agent = MODQN(env,batch_size=BATCH_SIZE,gamma=GAMMA,tau=TAU,lr=LR,utility_f=utility_f)
dqn_agent.train(20_000, enable_wandb_logging="online", wandb_group_name="MO_DQN_StaticOnstacleEnv_Utility_2", wandb_name=wandb_name)