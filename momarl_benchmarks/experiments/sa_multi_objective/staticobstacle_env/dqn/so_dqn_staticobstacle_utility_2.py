...
wandb_name = "SO_DQN_StaticOnstacleEnv_Utility_2"

dqn_agent = DQN(env,batch_size=BATCH_SIZE,gamma=GAMMA,tau=TAU,lr=LR,utility_f=utility_f,vectorial_reward=True)
dqn_agent.train(20_000, enable_wandb_logging="online", wandb_group_name="SO_DQN_StaticOnstacleEnv_Utility_2", wandb_name=wandb_name)