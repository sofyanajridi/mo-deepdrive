...
dqn_agent = DQN(env, batch_size=BATCH_SIZE, gamma=GAMMA, tau=TAU, lr=LR, utility_f=non_lin,vectorial_reward=True)
dqn_agent.train(50_000, enable_wandb_logging="online", wandb_group_name="DST_SODQN",
