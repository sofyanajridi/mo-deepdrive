...
notes = """Shaping reward to incent comfort"""
...
# eg.add('seed', 0)
eg.add('resume', '/home/c2/src/tmp/spinningup/data/intersection_2_agents_fine_tune_collision_resume/intersection_2_agents_fine_tune_collision_resume_s0_2020_03-12_18-17.21')
