...
experiment_name = 'deepdrive_2d-intersection-no-constrained-controls-example'
...
def train():
    ...
    # eg.add('seed', 0)
    eg.add('resume', '/home/c2/src/tmp/spinningup/data/deepdrive_2d-intersection-no-constrained-controls-example/deepdrive_2d-intersection-no-constrained-controls-example_s0_2020_03-10_13-14.50/best_HorizonReturn/2020_03-11_11-36.27')
