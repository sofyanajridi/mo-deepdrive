...
notes = """Trying with new per point lane pen, next try doubling pen to
 get similar to old weird no-margin pen, 
 then try re-enabling inside intersection pen"""
