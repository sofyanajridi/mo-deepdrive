...
notes = """Turns out that the "large" turn was being used for small adjustments
since 1 degree is actually quite a large steering change at high speeds. And
even at low speeds it was causing wobbles. So I've added a "micro" turn that
is 1/10th of a degree in addition to the previous actions. Interestingly this
will also be too large of a steering change at very high speeds (like 100mph),
so we'll need to add another fixed angle, like 1/100 degree or create a 
speed dependent small steer eventually."""
