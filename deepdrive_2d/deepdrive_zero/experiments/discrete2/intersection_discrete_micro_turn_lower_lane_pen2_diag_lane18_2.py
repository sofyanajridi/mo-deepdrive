...
notes = """This time try increasing lane penalty as we fine tune

ideas: 
- give reward for decay action
- fine tune earlier
- increase jerk penalty on fine tune
- use FFT and last 2 seconds of steering as input to penalize oscillations
"""
...
# eg.add('seed', 0)
eg.add('resume', '/home/c2/src/tmp/spinningup/data/intersection_discrete_micro_turn_lower_lane_pen2_diag_lane18/intersection_discrete_micro_turn_lower_lane_pen2_diag_lane18_s0_2020_05-15_14-03.41.998462')
