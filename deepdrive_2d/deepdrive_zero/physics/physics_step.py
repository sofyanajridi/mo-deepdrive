...
from deepdrive_2d.deepdrive_zero.constants import CACHE_NUMBA, MAX_STEER_CHANGE_PER_SECOND, \
...
def test_physics_step():
    from deepdrive_2d.deepdrive_zero.physics.bike_model import get_vehicle_model
