...
import deepdrive_2d.deepdrive_zero.physics.collision_detection
import deepdrive_2d.deepdrive_zero.physics.bike_model
import deepdrive_2d.deepdrive_zero.envs.env
import deepdrive_2d.deepdrive_zero.utils

MODULES_TO_TEST = [
    deepdrive_2d.deepdrive_zero.physics.collision_detection,
    deepdrive_2d.deepdrive_zero.physics.bike_model,
    deepdrive_2d.deepdrive_zero.envs.env,
    deepdrive_2d.deepdrive_zero.utils,
]
