...
def make_env(env_name, dss_act=False, worker_idx=None, multi_objective=False):
    base_info, folder_path = get_info_and_folder(env_name)

    if worker_idx is None:
        return Env(folder_path, base_info, dss_act, multi_objective)
    else:
        ...
        return Env(folder_path, info, dss_act, multi_objective)
